...
export function generateBetaInvitationEmailHtml({
  ...
  const content = `
    ...
    ${emailParagraph(`You've been invited to join <strong>Goal Achiever Pro</strong> beta — a goal-setting app built on Dan Martell's "Buy Back Your Time" methodology.`)}
    ...
    <ul style="margin: 0 0 16px 0; padding-left: 20px; color: #64748b; font-size: 16px; line-height: 1.8;">
      ...
      <li>Time audit with DRIP Matrix analysis</li>
